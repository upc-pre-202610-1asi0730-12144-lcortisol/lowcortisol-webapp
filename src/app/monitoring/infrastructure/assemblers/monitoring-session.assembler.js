...
import { MonitoringSessionResource } from "../resources/monitoring-session.resource";
...
export class MonitoringSessionAssembler extends BaseAssembler {
    ...
    toResource(entity) {
        return new MonitoringSessionResource({
            ...
            readings: this.readingAssembler.toResources(entity.readings ?? []),
            anomalies: this.anomalyAssembler.toResources(entity.anomalies ?? []),
